...
const DEFAULT_MARKER =
  "type:awesome;color:%235c5c5c;size:medium;icon:hand-spock";
const BAR_MARKER =
  "type:awesome;color:%23a82ecc;size:medium;icon:glass-martini";
...
var categoryCheckboxes = Array.from(
  document.getElementsByClassName("category-checkbox")
);
    ...
    features.forEach((feature, index) => {
      ...
      feature.properties.categories.every((category) => {
        if (category === "catering.cafe") {
          featureMarker = COFFEE_MARKER;
          return false;
        } else if (
          category === "catering.fast_food" ||
          category === "catering.restaurant"
        ) {
          featureMarker = FOOD_MARKER;
          return false;
        } else if (
          ...
          featureMarker = BAR_MARKER;
          return false;
        } else if (category === "catering.ice_cream") {
          featureMarker = ICE_MARKER;
          return false;
        }
...
function searchButton_Click() {
  ...
  //api.geoapify.com/v2/places?filter=circle:-81.421539,28.641699&apiKey=51c9b31a24364a49b55fcecffd8cb687

  //GeoApify Places API fetch
  https: fetch(PLACES_URL, API_REQUEST_OPTIONS)
